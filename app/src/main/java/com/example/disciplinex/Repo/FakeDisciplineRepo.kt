...
class FakeDisciplineRepository : DisciplineRepository {
    ...
    private val _blockedApps = MutableStateFlow(
        listOf(
            BlockedApp(name = "Instagram", iconRes = R.drawable.lock, isBlocked = true),
            BlockedApp(name = "YouTube", iconRes = R.drawable.lock, isBlocked = true),
            BlockedApp(name = "Facebook", iconRes = R.drawable.lock, isBlocked = true),
        )
    )
